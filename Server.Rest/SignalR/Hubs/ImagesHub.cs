...
//    //[AuthorizeSignalRViaTokenTableAttribute]
//    [TokenTableAuth]
...
//    //        var fuckYou = Startup.ServiceProvider.GetService<IHubContext<ImagesHub>>();

//    //        foreach (string fileName in Directory.GetFiles(path))
//    //        {
//    //            _context.Clients.All.SendAsync("notify", File.ReadAllBytes(fileName));
//    //            Thread.Sleep(16);//60FPS
//    //        }
//    //    }
//    //}
